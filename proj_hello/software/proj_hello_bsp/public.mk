...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../proj_hello.sopcinfo
...
# Design Name 
# setting SOPC_NAME is proj_hello
SOPC_NAME := proj_hello
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1708026628
SOPC_SYSID_FLAG += --timestamp=1708026628
ELF_PATCH_FLAG  += --timestamp 1708026628
